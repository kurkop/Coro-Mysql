# This Makefile is for the Coro::Mysql extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     DEFINE => q[ -DHAVE_EV=1]
#     INC => q[-I/usr/include/mysql -I/home/jarias/perl5/lib/perl5/x86_64-linux-thread-multi/EV -I/home/jarias/perl5/lib/perl5/x86_64-linux-thread-multi -I/usr/local/lib64/perl5/Coro]
#     LIBS => [q[-L/usr/lib64/mysql -lmysqlclient]]
#     NAME => q[Coro::Mysql]
#     PREREQ_PM => { Scalar::Util=>q[0], Guard=>q[1], DBD::mysql=>q[0], Coro=>q[5.1], DBI=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[Mysql.pm]
#     dist => { COMPRESS=>q[gzip -9v], PREOP=>q[pod2text Mysql.pm | tee README >$(DISTVNAME)/README; chmod -R u=rwX,go=rX . ;], SUFFIX=>q[.gz] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/jarias/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
INC = -I/usr/include/mysql -I/home/jarias/perl5/lib/perl5/x86_64-linux-thread-multi/EV -I/home/jarias/perl5/lib/perl5/x86_64-linux-thread-multi -I/usr/local/lib64/perl5/Coro
DEFINE =  -DHAVE_EV=1
...
MAN1PODS = 
MAN3PODS = Mysql.pm \
	Mysql/cache_server.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Coro
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Coro
...
PM_TO_BLIB = Mysql.pm \
	$(INST_LIB)/Coro/Mysql.pm \
	Mysql/cache_server.pm \
	$(INST_LIB)/Coro/Mysql/cache_server.pm
...
# Coro::Mysql might depend on some other libraries:
# See ExtUtils::Liblist for details
#
EXTRALIBS = -L/usr/lib64/mysql -lmysqlclient
LDLOADLIBS = -L/usr/lib64/mysql -lmysqlclient
BSLOADLIBS = 
LD_RUN_PATH = /usr/lib64/mysql
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Mysql.pm $(INST_MAN3DIR)/Coro::Mysql.$(MAN3EXT) \
	  Mysql/cache_server.pm $(INST_MAN3DIR)/Coro::Mysql::cache_server.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Coro-Mysql' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Coro: '\''5.1'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  DBD::mysql: '\''0'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  DBI: '\''0'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  Guard: '\''1'\''' >> META_new.yml
	$(NOECHO) $(ECHO) '  Scalar::Util: '\''0'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: '\''1.27'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Coro-Mysql",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Coro::" VERSION="5.1" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBD::mysql" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBI::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Guard::" VERSION="1" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  Mysql.pm $(INST_LIB)/Coro/Mysql.pm \
	  Mysql/cache_server.pm $(INST_LIB)/Coro/Mysql/cache_server.pm 
